...
export default function AcercaDePage() {
  return (
    <div className="animate-fade-in flex items-center justify-center min-h-[calc(100vh-140px)] py-16 px-6 md:px-12">
      <div className="bg-white border rounded-3xl shadow-sm my-8 px-10 py-16 sm:px-14 sm:py-20 md:px-16 md:py-24 flex flex-col items-center justify-center max-w-4xl w-full" style={{ borderColor: 'var(--color-border-light)' }}>
        ...
        {/* Divider */}
        <div className="w-full h-px my-6" style={{ backgroundColor: 'var(--color-border-light)' }} />
        ...
        <div className="flex flex-col items-center justify-center w-full mt-6">
          ...
          <p className="text-lg sm:text-xl font-medium text-center mb-6" style={{ color: 'var(--color-text-secondary)' }}>
