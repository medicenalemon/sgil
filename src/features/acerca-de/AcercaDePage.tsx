...
export default function AcercaDePage() {
  return (
    <div className="animate-fade-in flex items-center justify-center min-h-[calc(100vh-140px)] py-8 px-6 md:px-12">
      <div className="bg-white border rounded-3xl shadow-sm p-10 sm:p-14 md:p-16 flex flex-col items-center justify-center max-w-4xl w-full" style={{ borderColor: 'var(--color-border-light)' }}>
        
        {/* Superior: Logo y Versión */}
        <div className="flex flex-col items-center flex-grow justify-end pb-8">
          <img 
            src="/sgilcolor.png" 
            alt="SGIL Logo" 
            className="mb-5"
        ...
        {/* Divider */}
        <div className="w-full h-px my-4" style={{ backgroundColor: 'var(--color-border-light)' }} />

        {/* Medio: Info del Autor */}
        <div className="flex flex-col items-center flex-grow justify-start pt-8 w-full">
          <h2 className="text-3xl sm:text-4xl font-extrabold mb-3 tracking-tight text-center" style={{ color: 'var(--color-text-primary)' }}>
            Mauricio Alejandro Montero
          </h2>
          <p className="text-lg sm:text-xl font-medium text-center mb-4" style={{ color: 'var(--color-text-secondary)' }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 w-full max-w-3xl">
            <a 
              ...
              className="flex items-center justify-center gap-3 py-3 sm:py-4 px-6 rounded-2xl border hover:bg-gray-50 transition-all duration-200 hover:shadow-sm group"
